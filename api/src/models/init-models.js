...
export default function initModels(sequelize) {
    ...
    sensor_location.belongsTo(sensors, {
        as: "sensor",
        foreignKey: "sensor_id",
    });
    sensors.hasMany(sensor_location, {
        as: "sensor_locations",
        foreignKey: "sensor_id",
    });
    sensor_readings.belongsTo(sensors, {
        as: "sensor",
        foreignKey: "sensor_id",
    });
    sensors.hasMany(sensor_readings, {
        as: "sensor_readings",
        foreignKey: "sensor_id",
    });
    sensors_allocation.belongsTo(sensors, {
        as: "sensor",
        foreignKey: "sensor_id",
    });
    sensors.hasMany(sensors_allocation, {
        as: "sensors_allocations",
        foreignKey: "sensor_id",
    });
    sensors_allocation.belongsTo(usuario, {
        as: "id_usuario_usuario",
        foreignKey: "id_usuario",
    });
    usuario.hasMany(sensors_allocation, {
        as: "sensors_allocations",
        foreignKey: "id_usuario",
    });
